...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = include libsvm-2.8 liblr lib src
...
TSNNLS = 
VERSION = 0.9
abs_builddir = /home/jphan/Projects/CodeTree/miblab_library
abs_srcdir = /home/jphan/Projects/CodeTree/miblab_library
...
top_builddir = .
top_srcdir = .
#SUBDIRS = include libsvm-2.8 liblr lib
SUBDIRS = include libsvm-2.8 liblr lib src
#SUBDIRS = include libsvm-2.8 liblr lib
all: all-recursive
